...
<template>
  <div class="FollowingTrendJudgment">
      <div class="info">
          ...
          {{ $t('GrowthModel',{coin:presetData.coinName}) }}
      </div>
      <div class="table">
      <div class="table-content">
          <div class="c">
              <div class="header">
                  ...
                  <div class="th">2024</div>
                  <div class="th">2025</div>
                  <div class="th">2026</div>
                  <div class="th">2027</div>
              </div>
              <div class="tbody" v-for="(item,index) in growth_predict" :key="index">
                  <div class="td">{{ $t('GrowthModelTable',{
                    coin: presetData.coinName
                  }) }}{{ tableList[index] }}</div>
...
setup(props) {
    ...
    const growth_predict = ref(presetData.value.growth_predict)
    const tableList = ref(['1%','2%','5%','10%','20%','50%','100%'])
    onMounted(() => {
